...
function RecipieCard({ recipe, recommended }) {
    ...
    return (
        <div className={`${!recommended ? "w-full md:w-1/2 lg:w-1/3 max-xl:w-1/4 p-4" : "w-full rounded border "} font-rubic`}>
            <a className={`block relative h-48 overflow-hidden ${!recommended ? "rounded-lg" : "rounded !rounded-bl-none !rounded-br-none"}`}>
            ...
            <div className="px-4">
                ...
                <div className="my-4">
                    <Stack direction="horizontal" gap={2} className='md:my-4 p-1 flex flex-wrap'>
                    ...
                    {/*  */}
                    <Link to={`/recipe/${id}`} className="inline-flex items-center md:my-4 lg:mb-0 p-1 hover:text-[#f4b350]">
                        Recipe Details
